...
var metricHelp = map[string]string{
	...
	"netsec_system_cpu_temperature_celsius":      "Network security device CPU temperature in celsius",
	"netsec_system_device_status":                "Network security device system status (0 warning, 1 normal)",
	...
	"netsec_vs_session_active_current":           "Network security device virtual services active sessions (current)",
	"netsec_vs_sessions_new_per_second":          "Network security device virtual services new sessions per second (REAL-TIME)",
	"netsec_vs_total":                            "Network security device virtual services total",
	"netsec_pool_total":                          "Network security device pools total",
	"netsec_node_total":                          "Network security device nodes total",
	...
	"netsec_interface_traffic_out_bits_total":    "Network security device interface traffic out bits total",
	"netsec_interface_traffic_in_bits_total":     "Network security device interface traffic in bits total",
	...
	"netsec_interface_traffic_out_errors_total":  "Network security device interface traffic out errors total",
	"netsec_interface_traffic_in_errors_total":   "Network security device interface traffic in errors total",
	"netsec_interface_traffic_out_drops_total":   "Network security device interface traffic out drops total",
	"netsec_interface_traffic_in_drops_total":    "Network security device interface traffic in drops total",
	...
	"netsec_link_total":                          "Network security device logical link total",
	"netsec_link_type":                           "Network security device logical link type",

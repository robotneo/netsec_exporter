...
var metricHelp = map[string]string{
	...
	"netsec_uptime_seconds":                      "Network security device uptime in seconds",
	"netsec_fan_status":                          "Network security device fan status (1 normal, 0 abnormal)",
	"netsec_power_status":                        "Network security device power status (1 normal, 0 abnormal)",
	"netsec_temperature_status":                  "Network security device temperature sensor status (1 normal, 0 abnormal)",
	"netsec_temperature_current_celsius":         "Network security device temperature sensor current temperature in celsius",
	"netsec_temperature_min_celsius":             "Network security device temperature sensor lower alarm threshold in celsius",
	"netsec_temperature_max_celsius":             "Network security device temperature sensor upper alarm threshold in celsius",
